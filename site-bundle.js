...
(() => {
  ...
  function restoreBanner(){let b=document.querySelector('.banner'),h=document.querySelector('.header');if(!b&&h){b=document.createElement('div');h.before(b)}if(b){b.className='banner construction-banner';b.setAttribute('role','status');b.setAttribute('aria-label','Site status');b.innerHTML='<div class="wrap"><strong>Site under construction</strong></div>'}}
